...
class DishServiceTest {
    ...
    void getDish() {
        ...
        Exception exception = assertThrows(EntityReadException.class, () -> dishService.getDish("fake code"));
    ...
    void createDish() {
        ...
        Exception exception = assertThrows(EntityCreationException.class, () -> dishService.createDish(anotherDish));
