...
//        Exception exception = assertThrows(OwnerResourceCreationException.class, () -> customerService.createCustomer(anotherCustomer));
//
//        //then
...
//        Exception exception = assertThrows(OwnerResourceReadException.class, () -> customerService.modifyCustomerPersonalData(notExpected, "someEmail@mail.com"));
//
//        //then
//        assertTrue(result);
